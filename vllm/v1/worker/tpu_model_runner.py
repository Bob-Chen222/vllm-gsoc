...
class TPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def _prepare_inputs(self, scheduler_output: "SchedulerOutput",
        ...
        slot_mapping_metadata = jax.device_put(slot_mapping_metadata, jax.devices()[0])
        ...
        attn_metadata = PallasMetadata(
            ...
            num_seqs=jnp.array([num_reqs],
                                  dtype=jnp.int32),
            num_kv_update_slices=jnp.array([num_kv_update_slices],
                                              dtype=jnp.int32),
    ...
    def _dummy_run(self, num_tokens: int, num_reqs: int,
        ...
        context_lens = jnp.ones((num_reqs, ),
                                  dtype=jnp.int32)
        num_seqs = jnp.array([actual_num_reqs],
                                dtype=jnp.int32)
        attn_metadata = PallasMetadata(
