...
class AutoWeightsLoader:
    ...
    def _load_module(
        ...
        # NOTE(Bob): huge hack for now
        # we are assuming qwen2!!!!
        qwen_model = module.model
        qwen_model_load_weights = getattr(qwen_model, "load_weights", None)
        if callable(qwen_model_load_weights):
            loaded_params = qwen_model_load_weights(weights)
